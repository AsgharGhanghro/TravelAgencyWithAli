  ...
  return (
    <div className='py-16 bg-gray-100 '>
      <div data-aos="fade-up"
        ...
        <h3 className='text-3xl font-bold text-center mb-8 cursor-pointer transform transition duration-300 hover:scale-110 pt-16'>Our Service</h3>
       <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
        ...
        service.map((items,index)=>(
           <div  key={index} className='bg-white rounded-lg shadow-md flex flex-col  items-center px-6 p-14 cursor-pointer
            tranform transition duration-300 hover:scale-110  hover:shadow-slate-800 hover:bg-cyan-400'>
